...
public class SavingPostDTO {
    ...
    public SavingPostDTO(BigDecimal balance, Long idPrimaryOwner, Long idSecondaryOwner, String secretKey, String status, BigDecimal minimumBalance, BigDecimal interestRate) {
